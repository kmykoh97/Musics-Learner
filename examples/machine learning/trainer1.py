...
# =============================================================================
# this program is using sqaured error cost function
# there are several limitation with squared error cost function implemented in sigmoid training model:
# > graph obtained might be non-convex
# > might be diffucult to obtained global minimum and get local minima instead
# > difficult to implement gradient checking

# as a result, trainer1.py is rewriten in trainer2.py to overcome these limitation
# =============================================================================
...
def train(noTrain):
    ...
    for i in range(0, noTrain):
        ...
        cost = (activation - targetPoint) ** 2 # squared error cost function
        ...
        dcostdw1 = dcostdactivation * dactivationdhypothesis * dhypothesisdw1
